              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    widget.pokemon!.prevEvolution!.map<Widget>((evolution) =>
                        Chip(
                            backgroundColor: Colors.deepOrange.shade300,
                            label: Text(
                              evolution.name,
                  ...
                  Row(
                    ...
                    widget.pokemon!.nextEvolution!.map<Widget>((evolution) =>
                        Chip(
                            backgroundColor: Colors.deepOrange.shade300,
                            label: Text(
                              evolution.name,
                  ...
                  Row(
                    ...
                    widget.pokemon!.weaknesses.map<Widget>((weakness) =>
                        Chip(
                            backgroundColor: Colors.deepOrange.shade300,
                            label: Text(
                              weakness,
